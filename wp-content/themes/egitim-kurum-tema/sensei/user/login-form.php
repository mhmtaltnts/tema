...
<h2><?php esc_html_e( 'Giriş', 'sensei-lms' ); ?></h2>
...
<form method="post" name="sensi-login-form" id="loginform" class="login sensei">
	...
	<p class="sensei-login-username form-row form-row-wide">
				...
				<label for="sensei_user_login"><?php esc_html_e( 'Kullanıcı Adı veya Eposta', 'sensei-lms' ); ?> </label>
	...
	<p class="sensei-login-password form-row form-row-wide">
				...
				<label for="sensei_user_pass"> <?php esc_html_e( 'Şifre', 'sensei-lms' ); ?>  </label>
	...
	<p class='sensei-login-submit'>
		...
		<input type="submit" class="button" name="login" value="<?php esc_attr_e( 'Giriş', 'sensei-lms' ); ?>" />

		<a href="<?php echo esc_url( wp_lostpassword_url() ); ?>"  ><?php esc_html_e( 'Şireyi unuttunuz mu?', 'sensei-lms' ); ?> </a>
	...
	<p class='remember_me' >
		...
		<label for="rememberme" class="inline">
			...
			<input name="rememberme" type="checkbox" id="rememberme" value="forever" /> <?php esc_html_e( 'Beni hatırla', 'sensei-lms' ); ?>
