        ...
        <div class="group">
          ...
          <div class="site-footer__col-two-three-group">
            <div class="site-footer__col-two">
              ...
              <nav class="nav-list">
                ...
                <ul>
                  ...
                  <li><a href="<?php echo site_url('/giriscikis')?>">Kurslarım</a></li>
            ...
            <div class="site-footer__col-three">
              <h3 class="headline headline--small">İlginize</h3>
              <nav class="nav-list">
                <?php 
                /*
                 wp_nav_menu(array(
                ...
                */
                ...
                <ul>
                  ...
                  <li><a href="<?php echo site_url('/gizlilik-politikasi')?>">Gizlilik Politikamız</a></li>
          ...
          <div class="site-footer__col-four">
            <h3 class="headline headline--small">Sosyal Ağda Biz</h3>
            <nav>
